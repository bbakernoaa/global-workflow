...
class AerosolEmissions(Task):
    ...
    def initialize(self) -> None:
        ...
        # Fill the COMOUT_CHEM_HISTORY_TMPL with environment variables to create the full output path
        processed_files = []
        ...
        logger.info(f"Outputing files prescribed to {self.task_config.COM_CHEM_HISTORY_TMPL}")
        tmpl_dict = {
            'DATA': self.task_config.DATA,
            'COMOUT_CHEM_HISTORY': self.task_config.COMIN_CHEM_INPUT,
            'AERO_EMIS_FIRE_DIR': AERO_EMIS_FIRE_DIR,
        ...
        FileHandler(yaml_config.chem_emission.data_in).sync()
        ...
        if self.task_config.AERO_EMIS_FIRE.lower() == 'gbbepx':
            ...
            for forecast_date in self.forecast_dates:
                ...
                if date_files:
                    ...
                    template = self.task_config.chem_emission.config.OUTPUT_TEMPLATE
    ...
    def finalize(self) -> None:
        ...
        FileHandler(self.task_config.chem_emission.data_out).sync()
