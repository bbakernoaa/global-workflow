        ...
        for fh in IAUHH:
            if fh == 6:
                ...
                if os.path.isfile("sigi" + format(fh, "02") + ".nc"):
                    ...
                    gsi_utils.link_file(
                        ComOut + "/" + APrefix + "analysis.atm.a" + format(fh, "03") + ".nc", CalcAnlDir6 + "/anl." + format(fh, "02")
                    )
                    ...
                    if not os.path.exists(CalcAnlDir6):
                        gsi_utils.make_dir(CalcAnlDir6)
                    gsi_utils.link_file(
                        ComOut + "/" + APrefix + "ensres_analysis.atm.a" + format(fh, "03") + ".nc", CalcAnlDir6 + "/anl.ensres." + format(fh, "02")
                    )
                    gsi_utils.link_file(RunDir + "/sigi" + format(fh, "02") + ".nc", CalcAnlDir6 + "/siginc.nc." + format(fh, "02"))
                    gsi_utils.link_file(
                        ComIn_Ges + "/" + GPrefix + "ensres.atm.f" + format(fh, "03") + ".nc", CalcAnlDir6 + "/ges.ensres." + format(fh, "02")
                    )
