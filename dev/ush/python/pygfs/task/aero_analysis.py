...
from wxflow import AttrDict, FileHandler, YAMLFile, logit, parse_j2yaml, to_fv3time, to_timedelta
...
class AerosolAnalysis(Analysis):
    ...
    def __init__(self, config):
        ...
        for hour in self.task_config.aero_bkg_times:
            _bkg_times.append(self.task_config.WINDOW_BEGIN + to_timedelta(f"{hour!s}H") - to_timedelta(f"{self.task_config.assim_freq}H") / 2)
    ...
    def initialize(self) -> None:
        ...
        logger.info("Initializing JEDI variational DA application")
    ...
    def finalize(self) -> None:
        ...
        self.jedi_dict["aeroanlvar"].save_obsdataout(self.task_config.COMOUT_CHEM_ANALYSIS, f"{self.task_config.APREFIX}aero_analysis.ioda_hofx")
        ...
        self.jedi_dict["aeroanlvar"].save_obsbiasout(self.task_config.COMOUT_CHEM_ANALYSIS, f"{self.task_config.APREFIX}aero_varbc_params")
