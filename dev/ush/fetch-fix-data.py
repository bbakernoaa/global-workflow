...
logging.basicConfig(filename="fetch-fix-data.log", format="%(asctime)s %(message)s", filemode="w")
...
class FetchFIXdata:
    ...
    def __init__(self, atmgridarray=["C48"], ocngridarray=["500"], fix_bucket=None, fix_ver=None, localdir=None, verbose=False):
    ...
    def get_fix_ver_dict(self):
        ...
        self.fix_ver_dict = {}
        with open(self.fix_ver) as file:
...
def main() -> None:
    ...
    parser.add_argument("-d", "--localdir", type=str, required=True, help="local directory to store FIX data subset")
    parser.add_argument("-f", "--fix_ver", type=str, required=True, default="unknown", help="fix.ver file from Global-Workflow versions directory")
    parser.add_argument(
        "-b",
        "--fix_bucket",
        type=str,
    ...
    parser.add_argument("-a", "--atmgrid", type=str, required=False, default="C48", help="ATM grid, like: C48,C96,C192,C384,C768,C1152, default: C48")
    parser.add_argument("-o", "--ocngrid", type=str, required=False, default="100", help="OCN grid, like: 500,100,050,025, default: 100")
